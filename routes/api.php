...
Route::group(['prefix' => 'app', 'middleware' => 'auth:api'], function() {
    ...
    Route::post('data-table/expiration/save', '\Platform\Controllers\App\DataTableController@postSaveExpiration');
    Route::post('data-table/expiration/delete', '\Platform\Controllers\App\DataTableController@postDeleteExpiration');
...
Route::group(['prefix' => 'campaign', 'middleware' => 'auth:customer'], function() {
    ...
    //Get Earn or Redeem for use with QR
    Route::post('get-earn-or-redeem', '\Platform\Controllers\Campaign\PointController@postGetEarnOrRedeem');
...
Route::group(['prefix' => 'staff', 'middleware' => 'auth:staff'], function() {
    ...
    //DataTable
    Route::get('data-table', '\Platform\Controllers\Staff\DataTableController@getDataList');
    Route::get('data-table/export', '\Platform\Controllers\Staff\DataTableController@getExport');
    Route::post('data-table/expiration/save', '\Platform\Controllers\Staff\DataTableController@postSaveExpiration');
    Route::post('data-table/expiration/delete', '\Platform\Controllers\Staff\DataTableController@postDeleteExpiration');

    // DataForm
    Route::get('data-form', '\Platform\Controllers\Staff\DataFormController@getDataForm');
    Route::post('data-form/relation', '\Platform\Controllers\Staff\DataFormController@postGetRelation');
    Route::post('data-form/save', '\Platform\Controllers\Staff\DataFormController@postSaveRecord');

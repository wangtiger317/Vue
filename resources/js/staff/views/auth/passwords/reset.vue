          ...
          <v-card class="elevation-18">
            ...
            <v-card-text>
              ...
              <v-alert
                ...
                class="mb-4"
                >
                {{ $t('Código inválido, já usado ou expirado.') }}
              </v-alert>
              ...
              <el-alert
                ...
                class="mb-1"
                show-icon>
                <p>{{ $t('Existem erros no formulário. Por favor corrija antes de continuar.') }}</p>
              </el-alert>
            ...
            <v-card-actions v-if="!invalid_token">
              <v-btn color="primary" :loading="form1.loading" :disabled="form1.loading" large block type="submit">{{ $t('Atualizar palavra-passe') }}</v-btn>
            </v-card-actions>
          </v-card>
        </v-form>
      </v-flex>

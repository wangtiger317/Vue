              ...
              <v-layout>
                ...
                >
                  ...
                  <v-tabs-items v-model="selectedTab" :touchless="false">
                    ...
                    <v-tab-item :value="'localization'">
                      ...
                      <v-autocomplete
                        ...
                        item-value="0"
                        item-text="1"
                        label="Selecione o fuso horário"
                        data-vv-name="timezone"
                        data-vv-as="Fuso horário"
                        v-validate="'required'"
                    ...
                    <v-tab-item :value="'password'">
                      <v-text-field
                        ...
                        :data-vv-as="$t('Palavra-passe').toLowerCase()"
                        v-validate="'min:8|max:24'"
                        :label="$t('Mudar palavra-passe')"
                        :hint="$t('Deixe vazio se não quiser alterar a palavra-passe.')"
                  ...
                  <v-text-field
                    ...
                    :data-vv-as="$t('Palavra-passe atual').toLowerCase()"
                    v-validate="'required|min:8|max:24'"
                    :label="$t('Palavra-passe atual')"

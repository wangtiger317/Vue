      ...
      <v-flex xs10 sm10 md6 lg5 xl4>
        <v-card class="elevation-18">
          ...
          <div v-if="validToken === true && credited === false">
            ...
            >
              <v-card-text>
                <p class="body-1">Pode creditar pontos ao cliente abaixo.</p>
              ...
              <v-card-actions>
                <v-spacer></v-spacer>
                <v-btn color="primary" :loading="creditPoints.loading" :disabled="creditPoints.code !== false" type="submit">Adicionar pontos</v-btn>
              </v-card-actions>
          ...
          <div v-if="credited === true">
            ...
            <v-card-text>
              <p class="body-1">Os pontos foram creditados ao cliente com sucesso.</p>
    ...
    created () {
      ...
      axios
        ...
        .then(response => {
          ...
          this.creditPoints.points = response.data.pre_points;
        })

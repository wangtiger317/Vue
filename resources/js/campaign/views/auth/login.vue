        ...
        <v-form
          ...
          <v-card class="elevation-18 my-4">
            ...
            <v-layout align-center justify-end row>
              <v-btn text small :to="{name: 'password.email'}" tabindex="-1" color="grey" style="font-size: 12px">{{ $t('forgot_password') }}</v-btn>
            </v-layout>
            ...
            <v-card-actions class="pt-0">
              <v-btn @click="toRegister" :disabled="form1.loading" large block text>{{ $t('or_create_a_new_account') }}</v-btn>
            </v-card-actions>
          </v-card>
        </v-form>
      </v-flex>

...
class User extends Authenticatable implements JWTSubject, HasMedia
{
          ...
          'subs' => [
            'sub1' => [
              'items' => [
                ...
                ['type' => 'email', 'column' => 'email', 'text' => __('E-mail address'), 'validate' => 'nullable|email|max:48', 'icon' => 'email'],
    ...
    public static function getSettings() {
      $owner = ['select_all' => true, 'actions' => true, 'create' => false, 'actions_width' => '77px'];
      $reseller = $owner;
      $user = $owner;
    ...
    public function getUserStats($statsPeriod = '7days') {
      ...
      $customerSignupsTotalPrevious = (int) $data[0];
    ...
    public function getEarningsForPeriod($statsPeriod = '7days') {
      ...
      $earningsTotalPrevious = (int) $data[0];
    ...
    public function getSpendingsForPeriod($statsPeriod = '7days') {
      ...
      $spendingsTotalPrevious = (int) $total[0];

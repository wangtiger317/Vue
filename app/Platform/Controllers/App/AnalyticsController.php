...
class AnalyticsController extends \App\Http\Controllers\Controller
{
    ...
    */
    ...
    public function getUserEarningAnalytics(Request $request) {
        ...
        $customers = auth()->user()->customers->pluck('email', 'id');
        ...
        $table = $table->map(function ($record) use ($campaigns, $staff, $customers) {
            ...
            $record->customer_email = $customers[$record->customer_id];
            ...
            return collect($record)->only('uuid', 'staff_name', 'customer_email', 'campaign_name', 'description', 'icon', 'created_at', 'points');
        });

        // Table headers
        $tableHeaders = [
            ['text' => __('Campanha'), 'value' => 'campaign_name'],
            ['text' => __('Cliente'), 'value' => 'customer_email'],
            ['text' => __('Evento'), 'value' => 'description'],
            ['text' => __('Funcionário'), 'value' => 'staff_name'],
            ['text' => __('Pontos'), 'value' => 'points', 'align' => 'right'],
            ['text' => __('Data'), 'value' => 'created_at', 'align' => 'right']
        ];
...
//        echo json_encode($analytics);
    ...
    public function getUserSpendingAnalytics(Request $request) {
        ...
        $table = $table->map(function ($record) use ($campaigns, $staff, $customers) {
            ...
            return collect($record)->only('uuid', 'staff_name', 'customer_email', 'campaign_name', 'reward_title', 'description', 'icon', 'created_at', 'points');
        });

        // Table headers
        $tableHeaders = [
            ['text' => __('Campanhas'), 'value' => 'campaign_name'],
            ['text' => __('Clientes'), 'value' => 'customer_email'],
            ['text' => __('Prémio'), 'value' => 'reward_title'],
            ['text' => __('Pontos'), 'value' => 'points', 'align' => 'right'],
            ['text' => __('Evento'), 'value' => 'description'],
            ['text' => __('Funcionário'), 'value' => 'staff_name'],
            ['text' => __('Data'), 'value' => 'created_at', 'align' => 'right']

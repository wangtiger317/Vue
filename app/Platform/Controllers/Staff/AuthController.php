    ...
    */
    ...
    public function postUpdateProfile(Request $request) {
      ...
      $v = Validator::make($request->all(), [
        ...
        'email' => ['required', 'email', 'max:32', Rule::unique('staff')->where(function ($query) use ($account) {
    ...
    public function user(Request $request) {
      ...
      $admin = User::withoutGlobalScopes()->where('id', $user->created_by)->where('active', 1)->firstOrFail();
      // Login correct, check if staff member has permission to this campaign/business
      ...
      $return = [
        ...
        'expired' => ($admin->expires === null) ? false : $admin->expires->isPast(),

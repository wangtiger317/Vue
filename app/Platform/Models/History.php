...
class History extends Model
{
      ...
      $owner = [
        'tab1' => [
          'subs' => [
            'sub1' => [
              'items' => [
                ['type' => 'text', 'column' => 'event', 'text' => __('Evento'), 'validate' => 'required|max:250', 'required' => true],
              ]
            ]
          ]
        ]
    ...
    public static function getHeaders() {
      $owner = [
        ['visible' => true, 'value' => 'event', 'text' => __('Evento'), 'align' => 'left', 'sortable' => true]
      ];
      $reseller = $owner;
      $user = $owner;
    ...
    public function getIconAttribute() {
      ...
      switch ($this->event) {
        case 'Bónus: cliente registou-se': $icon = 'sentiment_satisfied_alt'; break;
      }
      return $icon;
    }
    ...
    public function getIconSizeAttribute() {
      ...
      switch ($this->event) {
        case 'Bónus: cliente registou-se': $size = 'large'; break;
      }
      return $size;
    }
    ...
    public function getColorAttribute() {
      ...
      switch ($this->event) {
        case 'Bónus: cliente registou-se': $color = 'orange darken-2'; break;
      }
      return $color;
    }

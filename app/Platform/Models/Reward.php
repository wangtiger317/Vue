...
class Reward extends Model implements HasMedia
{
      ...
      $owner = [
        'tab1' => [
          ...
          'subs' => [
            'sub1' => [
              'items' => [
                ['type' => 'text', 'column' => 'title', 'text' => __('Título'), 'validate' => 'required|max:64', 'required' => true],
                ['type' => 'number', 'column' => 'points_cost', 'text' => __('Pontos necessários'), 'validate' => 'required|integer|min:1|max:1000000', 'required' => true],
                ['type' => 'currency', 'prefix' => auth()->user()->getCurrencyFormat('symbol'), 'suffix' => auth()->user()->getCurrency(), 'column' => 'reward_value', 'text' => __('Valor do prémio'), 'validate' => 'required|decimal:' . auth()->user()->getCurrencyFormat('fraction_digits') . '|min:0|max:1000000', 'required' => true],
                ['type' => 'boolean', 'default' => true, 'column' => 'active', 'text' => __('Activo'), 'validate' => 'nullable']
              ]
            ]
          ]
        ],
        'tab2' => [
          ...
          'subs' => [
            'sub1' => [
              'items' => [
                ['type' => 'date_time', 'default' => Carbon::now()->format('Y-m-d H:00:00'), 'format' => 'LLLL', 'column' => 'active_from', 'text' => __('Activo desde'), 'validate' => 'required', 'required' => true, 'icon' => 'calendar_today'],
                ['type' => 'date_time', 'default' => Carbon::now()->addMonths(18)->format('Y-m-d H:00:00'), 'format' => 'LLLL', 'column' => 'expires_at', 'text' => __('Expira em'), 'validate' => 'required', 'required' => true, 'icon' => 'calendar_today']
              ]
            ]
          ]
        ],
        'tab3' => [
          ...
          'subs' => [
            'sub1' => [
              'items' => [
                ['type' => 'wysiwyg', 'config' => ['toolbar' => ['bold', 'italic', '|', 'link']], 'column' => 'description', 'text' => __('Descrição'), 'validate' => 'nullable'],
              ]
            ]
          ]
        ],
        'tab4' => [
          ...
          'subs' => [
            'sub1' => [
              'items' => [
                ['type' => 'image', 'image' => ['thumb_max_width' => '180px', 'thumb_max_height' => '120px'], 'column' => 'main_image', 'text' => __('Imagem principal'), 'validate' => 'nullable', 'icon' => 'attach_file'],
                ['type' => 'image', 'image' => ['thumb_max_width' => '180px', 'thumb_max_height' => '120px'], 'column' => 'image1', 'text' => __('Imagem adicional') . ' 1', 'validate' => 'nullable', 'icon' => 'attach_file'],
                ['type' => 'image', 'image' => ['thumb_max_width' => '180px', 'thumb_max_height' => '120px'], 'column' => 'image2', 'text' => __('Imagem adicional') . ' 2', 'validate' => 'nullable', 'icon' => 'attach_file'],
                ['type' => 'image', 'image' => ['thumb_max_width' => '180px', 'thumb_max_height' => '120px'], 'column' => 'image3', 'text' => __('Imagem adicional') . ' 3', 'validate' => 'nullable', 'icon' => 'attach_file'],
                ['type' => 'image', 'image' => ['thumb_max_width' => '180px', 'thumb_max_height' => '120px'], 'column' => 'image4', 'text' => __('Imagem adicional') . ' 4', 'validate' => 'nullable', 'icon' => 'attach_file'],
              ]
            ]
          ]
        ]
    ...
    public static function getTableFilters() {
      $owner = [
        ['column' => 'campaigns', 'text' => __('Todas as campanhas'), 'icon' => 'filter_list', 'type' => 'relation', 'default' => null, 'relation' => ['type' => 'belongsToMany', 'permission' => 'personal', 'with' => 'campaigns', 'table' => 'campaigns', 'pk' => 'id', 'val' => 'name', 'orderBy' => 'name', 'order' => 'asc']]
      ];
      $reseller = $owner;
      $user = $owner;
    ...
    public static function getTranslations() {
      return [
        'items' => __('Prémios'),
        'edit_item' => __('Editar prémio'),
        'create_item' => __('Criar prémio'),
      ];
    }
    ...
    public static function getHeaders() {
      $owner = [
        ['visible' => true, 'value' => 'title', 'style' => ['min-width'=> '120px'], 'text' => __('Título'), 'align' => 'left', 'sortable' => true],
        ['visible' => true, 'value' => 'points_cost', 'type' => 'number', 'text' => __('Pontos'), 'align' => 'right', 'sortable' => true, 'default_order' => true],
        ['visible' => true, 'value' => 'active_from', 'type' => 'date_time', 'color_is_future' => '#b71c1c', 'format' => 'll', 'text' => __('Activo desde'), 'align' => 'left', 'sortable' => true],
        ['visible' => true, 'value' => 'expires_at', 'type' => 'date_time', 'color_is_past' => '#b71c1c', 'format' => 'll', 'text' => __('Expira em'), 'align' => 'left', 'sortable' => true],
        ['visible' => true, 'value' => 'number_of_times_redeemed', 'type' => 'number', 'text' => __('Resgatados pelo cliente'), 'align' => 'right', 'sortable' => true],
        ['visible' => true, 'value' => 'active', 'text' => __('Activo'), 'align' => 'center', 'sortable' => true, 'type' => 'boolean'],
        ['visible' => true, 'value' => 'main_image_thumb', 'type' => 'image', 'exclude_from_select' => true, 'max_width' => '140px', 'text' => __('Imagem'), 'align' => 'left', 'sortable' => false]
      ];
      $reseller = $owner;
      $user = $owner;

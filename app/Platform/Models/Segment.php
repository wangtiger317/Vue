...
class Segment extends Model
{
          ...
          'subs' => [
            'sub1' => [
              'items' => [
                ...
                ['type' => 'relation', 'relation' => ['type' => 'belongsToMany', 'permission' => 'personal', 'with' => 'businesses', 'remote_pk' => 'business_id', 'table' => 'businesses', 'pk' => 'id', 'val' => 'name', 'orderBy' => 'name', 'order' => 'asc'], 'text' => __('Estabelecimento'), 'validate' => 'nullable'],
              ]
            ]
          ]
        ]
    ...
    public static function getTableFilters() {
      $owner = [
        ['column' => 'businesses', 'text' => __('Todos os negócios'), 'icon' => 'filter_list', 'type' => 'relation', 'default' => null, 'relation' => ['type' => 'belongsToMany', 'permission' => 'personal', 'with' => 'businesses', 'table' => 'businesses', 'pk' => 'id', 'val' => 'name', 'orderBy' => 'name', 'order' => 'asc']]
      ];
      $reseller = $owner;
      $user = $owner;
    ...
    public static function getHeaders() {
      $owner = [
        ['visible' => true, 'value' => 'name', 'text' => __('Segmento'), 'align' => 'left', 'sortable' => true],
        ['visible' => true, 'value' => 'businesses_text', 'exclude_from_select' => true, 'relation' => ['type' => 'belongsToMany', 'with' => 'businesses', 'table' => 'businesses', 'val' => 'name'], 'text' => __('Estabelecimento'), 'align' => 'left', 'sortable' => false]
      ];
      $reseller = $owner;
      $user = $owner;

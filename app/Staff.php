...
class Staff extends Authenticatable implements JWTSubject, HasMedia
{
      ...
      $owner = [
        'tab1' => [
          ...
          'subs' => [
            'sub1' => [
              'items' => [
                ['type' => 'relation', 'relation' => ['type' => 'belongsToMany', 'permission' => 'personal', 'with' => 'businesses', 'remote_pk' => 'business_id', 'table' => 'businesses', 'pk' => 'id', 'val' => 'name', 'orderBy' => 'name', 'order' => 'asc'], 'text' => __('Estabelecimento'), 'validate' => 'required', 'required' => true],
                ['type' => 'text', 'column' => 'name', 'text' => __('Nome'), 'validate' => 'required|max:32', 'required' => true],
                ['type' => 'email', 'column' => 'email', 'text' => __('Endereço de e-mail'), 'validate' => 'required|email|max:48', 'required' => true],
                ['type' => 'password', 'column' => 'password', 'text' => __('Palavra-passe'), 'hint_edit' => __('Deixe este campo vazio se não deseja alterar a palavra-passe'), 'validate' => 'nullable|min:8|max:32', 'validate_create' => 'nullable|min:8|max:32', 'required_create' => true],
                ...
                ['type' => 'boolean', 'default' => true, 'column' => 'active', 'text' => __('Ativo'), 'validate' => 'nullable']
              ]
            ]
          ]
        ]
    ...
    public static function getTranslations() {
      return [
        'items' => __('Funcionários'),
        'edit_item' => __('Editar funcionário'),
        'create_item' => __('Criar funcionário'),
      ];
    }
    ...
    public static function getHeaders() {
      $owner = [
        ...
        ['visible' => true, 'value' => 'name', 'text' => __('Nome'), 'align' => 'left', 'sortable' => true],
        ['visible' => true, 'value' => 'email', 'text' => __('E-mail'), 'align' => 'left', 'sortable' => true],
        ['visible' => true, 'value' => 'businesses_text', 'exclude_from_select' => true, 'relation' => ['type' => 'belongsToMany', 'with' => 'businesses', 'table' => 'businesses', 'val' => 'name'], 'text' => __('Estabelecimento(s)'), 'align' => 'left', 'sortable' => false],
